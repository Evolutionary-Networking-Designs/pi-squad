...
let doclingAvailableCache = null;
/**
 ...
 */
export async function convertDocument(filePath) {
    ...
    if (BINARY_EXTENSIONS.has(ext)) {
        console.warn(`[pi-squad/ingestion] Docling is not installed. Cannot extract text from ${filePath}. ` +
    ...
    try {
        ...
        console.warn(`[pi-squad/ingestion] Cannot read ${filePath} as text and Docling is not available.`);
        return "";
    }
}
/**
 ...
 */
export function resetDoclingAvailabilityCache() {
    doclingAvailableCache = null;
}
// ─── Internal helpers ─────────────────────────────────────────────────────────
async function runDocling(filePath) {
...
//# sourceMappingURL=docling.js.map