 ...
 */
export enum ContextPressureLevel {
...
export interface TokenAnalytics {
  ...
  queryTrend(
    sessionId: string,
    windowMs: number,
  ): Promise<{ avgPercent: number; peakPercent: number; sampleCount: number }>;
...
export class ContextOverflowError extends Error {
  public readonly name = "ContextOverflowError" as const;
  ...
  constructor(
    ...
    public readonly attempts: readonly RecoveryAttempt[],
...
export class CheckpointError extends Error {
  public readonly name = "CheckpointError" as const;
...
export class ContextConfigError extends Error {
  public readonly name = "ContextConfigError" as const;
